...
class WxValidate {
  ...
  __initMethods() {
    ...
    that.methods = {
       ...
       */
      wechat(value) {
        return that.optional(value) || /^[a-zA-Z]([-_a-zA-Z0-9]{5,19})+$/.test(value)
	  },
      /**
       * 验证URL格式
       */
       ...
       */
      idcard(value) {
        return that.optional(value) || /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/.test(value)
      },
      /**
       * 验证两个输入框的内容是否相同
       */
